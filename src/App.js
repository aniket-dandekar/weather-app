...

      {
        data ?
          <main className="p-2 sm:p-6 flex flex-col justify-center darkmode-class color-transit">
            ...
            <h1 className="text-center text-2xl my-2 font-semibold">Please reload the page with loaction access.</h1><p><a className="text-center mx-auto" href="/">Click here to reload</a></p></main>)
      }
    </>
  );
}
